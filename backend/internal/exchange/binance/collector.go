...
// CandleRepository defines the interface for storing candles
// This will be implemented by the repository layer
type CandleRepository interface {
	SaveBatch(ctx context.Context, candles []*domain.Candle, interval string) error
}

// Collector collects historical candle data from Binance
