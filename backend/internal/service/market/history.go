...
import (
	...
	"github.com/lavumi/crypto-quant/internal/exchange"
	"github.com/lavumi/crypto-quant/internal/repository"
)

// HistoryService handles historical market data operations
type HistoryService struct {
	candleRepo *repository.CandleRepository
	tradeRepo  *repository.TradeRepository
	provider   exchange.HistoricalDataProvider
}
...
func (s *HistoryService) CollectHistoricalData(ctx context.Context, symbol, interval string, startTime, endTime time.Time) error {
	if err := s.provider.CollectHistorical(ctx, symbol, interval, startTime, endTime); err != nil {
...
func (s *HistoryService) GetCandles(ctx context.Context, symbol, interval string, start, end time.Time) ([]*domain.Candle, error) {
...
func (s *HistoryService) GetLatestCandle(ctx context.Context, symbol, interval string) (*domain.Candle, error) {
...
func (s *HistoryService) SaveTrade(ctx context.Context, trade *domain.Trade) error {
...
func (s *HistoryService) GetTradeHistory(ctx context.Context, symbol string) ([]*domain.Trade, error) {
...
func (s *HistoryService) ValidateDataAvailability(ctx context.Context, symbol, interval string, startTime, endTime time.Time) (*DataValidationResult, error) {
...
func (s *HistoryService) GetDataRange(ctx context.Context, symbol, interval string) (*time.Time, *time.Time, error) {
